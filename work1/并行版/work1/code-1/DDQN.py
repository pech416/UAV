...
class DeepQNetwork(nn.Module):
    def __init__(self, alpha, state_dim, action_dim, fc1_dim, fc2_dim, fc3_dim):
        ...
        self.optimizer = optim.Adam(self.parameters(), lr=alpha, betas=(0.9, 0.999), eps=1e-08)
        self.to(device)
...
class DDQN:
    def __init__(self, alpha, state_dim, action_dim, fc1_dim, fc2_dim, fc3_dim, ckpt_dir,
                 gamma=0.95, tau=0.005, epsilon=1.0, eps_end=0.01, eps_dec=0.001,
                 max_size=5000, batch_size=128):
        self.gamma = gamma
        self.tau = tau
